---
title: Spring AI + Ollama + DeepSeek 聊天应用
---
...
<img src="/images/image-20250402095229042.png" alt="案例效果" style="zoom: 67%;" />
...
![](/images/image-20250328102511007.png)
...
![](/images/image-20250520154117933.png)
...
![](/images/image-20250520154256674.png)

双击已下载的mysql-installer-community-8.0.42.0.msi文件，即可启动安装程序。

![](/images/image-20250520155104741.png)
...
![](/images/image-20250520155226646.png)
...
![](/images/image-20250520155852870.png)

点击【Execute】（执行）按钮，启动安装进程。一旦安装完成，界面上将呈现3个绿色的勾选标记。

![](/images/image-20250520160558139.png)

完成MySQL的安装后，紧接着需要对服务器进行配置。以下是具体的配置步骤：

在上一节的最后一步中，点击【Next】（下一步）按钮，将引导您进入产品信息窗口。

![](/images/f8438d0e933d7e8bc20894650f163a51.png)

点击【Next】（下一步）按钮后，您将进入服务器配置窗口。在此，选择采用默认配置。

![](/images/f8438d0e933d7e8bc20894650f163a51-17477284644022.png)

在服务器配置窗口中，【Config Type】选项允许您设定服务器的类型。通过点击该选项右侧的下三角按钮，将呈现三个可选项供您选择。

<img src="/images/171e53696bf7d90220c231201cffebd5.png" alt="171e53696bf7d90220c231201cffebd5" style="zoom:80%;" />
...
<img src="/images/f02fc7c827047ee226393a0dd4a83198.png" alt="f02fc7c827047ee226393a0dd4a83198" style="zoom:80%;" />
...
![](/images/image-20250429105703514.png)

- 下载的文件：

  ![](/images/image-20250429105830827.png)

**步骤2：安装Ollama**

- 下载完成后，得到"OllamaSetup.exe"文件，运行该文件，点击"Install"开始安装，按照提示完成安装过程。

![](/images/image-20250429105923764.png)

**步骤3：验证安装**

- 安装完成之后，打开一个新的命令提示符窗口，输入"ollama"命令，如果显示ollama相关的信息就证明安装已经成功了！

  ![](/images/image-20250429110003702.png)
...
<img src="/images/image-20250221165627535.png" alt="image-20250221165627535" style="zoom:80%;" />
...
- 运行deepseek后可以与其对话
  ...
  ![](/images/image-20250429111035538.png)
